      ...
      <div className="container mx-auto">
        <div className="tab container mx-auto ">
          <Tabs defaultIndex={0} className=" ">
            <TabList className="flex md:space-x-8  md:flex-row flex-col text-center gap-6   md:justify-center mb-10 ">
              <Tab>
                <button
                  type="button"
              ...
              <div className="  px-4 md:px-0 mb-16">
                ...
                <div className=" flex justify-end">
                  <button
                    ...
                    style={{
                      backgroundColor: mode === false ? "rgb(46 49 55)" : "",
